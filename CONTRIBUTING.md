# Contributing to XXXXXXX

♥ [XXXXXXX](https://dkbrummitt.github.io/xxxxxxx) and want to get involved?
...
The [issue tracker](https://github.com/dkbrummitt/xxxxxxx/issues) is
...
* Please **do not** open issues or pull requests regarding the code in
  [`.htaccess`](https://github.com/dkbrummitt/server-configs-apache),
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your
   ...
   git remote add upstream https://github.com/dkbrummitt/xxxxxxx.git
   ```
